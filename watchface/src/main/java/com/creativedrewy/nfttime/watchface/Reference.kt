 ...
 */
//class NFTimeWatchFace : CanvasWatchFaceService() {
//
//    override fun onCreateEngine(): Engine {
//        return Engine()
//    }
//
//    private class EngineHandler(reference: NFTimeWatchFace.Engine) : Handler(Looper.myLooper()!!) {
//        private val mWeakReference: WeakReference<NFTimeWatchFace.Engine> = WeakReference(reference)
//
...
//
//            setWatchFaceStyle(
//                WatchFaceStyle.Builder(this@NFTimeWatchFace)
...
//            this@NFTimeWatchFace.registerReceiver(mTimeZoneReceiver, filter)
//        }
//
...
//            this@NFTimeWatchFace.unregisterReceiver(mTimeZoneReceiver)
//        }
//
//        /**
